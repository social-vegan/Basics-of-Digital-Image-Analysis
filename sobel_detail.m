...
figure, imshow(uint8(I)), title('Sobel - Vertical'); 
...
figure, imshow(uint8(I)),title('Sobel - Horizontal'); 
%%
I=(imread('img6.gif'));
%I=rgb2gray(I);
I=double(I); %read image 
...
figure, imshow(uint8(I)),title('Sobel - Principal Diagonal'); 
%%
I=(imread('img6.gif'));
%I=rgb2gray(I);
I=double(I); %read image 
...
figure, imshow(uint8(I)),title('Sobel - Secondary Diagonal'); 
%%
I=(imread('img6.gif'));
%I=rgb2gray(I);
I=double(I); %read image 
...
figure, imshow(uint8(I)),title('Sobel - Edge Detected'); 
